...
pub struct MapUnit {
    pub unit: i32,
    pub host_terrain: i32,
    pub group_placing: u8,
    pub scale_flag: u8,
    pub padding_1: i16,
    pub objects_per_group: i32,
    pub fluctuation: i32,
    pub groups_per_player: i32,
    pub group_arena: i32,
    pub player_id: i32,
    pub set_place_for_all_players: i32,
...
pub struct MapTerrain {
    ...
    pub terrain: i32,
    pub clump_count: i32,
    pub edge_spacing: i32,
    pub placement_terrain: i32,
    pub clumpiness: i32,
}
...
pub struct MapLand {
    ...
    pub base_x: i32,
    pub base_y: i32,
    pub land_proportion: u8,
    pub by_player_flag: u8,

    #[br(ignore)]
    #[bw(calc = 0)]
    padding_2: i16,

    pub start_area_radius: i32,
    pub terrain_edge_fade: i32,
    pub clumpiness: i32,
}
...
pub struct MapInfo {
    pub map_id: i32,
    pub border_south_west: i32,
    pub border_north_west: i32,
    pub border_north_east: i32,
    pub border_south_east: i32,
    pub border_usage: i32,
    pub water_shape: i32,
    pub base_terrain: i32,
    pub land_coverage: i32,
    pub unused_id: i32,
    ...
    pub map_terrains: Vec<MapTerrain>,
    ...
    pub map_elevations: Vec<MapElevation>,
}
...
pub struct RandomMaps {
    ...
    pub map_info_1: Vec<MapInfo>,
    #[br(count = random_map_count)]
    pub map_info_2: Vec<MapInfo>,
}
