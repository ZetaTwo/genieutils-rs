...
pub struct Terrain {
    ...
    pub blend_type: i32,
    pub overlay_mask_name: DebugString,
    pub colors: (u8, u8, u8),
    pub cliff_colors: (u8, u8),
    pub passable_terrain: u8,
    pub impassable_terrain: u8,
    pub is_animated: u8,
...
pub struct TerrainBlock {
    ...
    pub map_max_x: f32,
    pub map_max_y: f32,
    pub map_max_x_plus_1: f32,
    pub map_max_y_plus_1: f32,
    pub terrains_used_2: i16,
    ...
    pub cur_row: i16,
    pub cur_col: i16,
    pub block_beg_row: i16,
    pub block_end_row: i16,
    pub block_beg_col: i16,
